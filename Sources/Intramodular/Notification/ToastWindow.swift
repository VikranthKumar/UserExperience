...
open class ToastWindow: UIWindow {
    ...
    public static let shared = ToastWindow(frame: UIScreen.main.bounds, mainWindow: UIApplication.shared.firstKeyWindow)
    ...
    public init(frame: CGRect, mainWindow: UIWindow?) {
        ...
        if let orientation = UIApplication.shared.firstKeyWindow?.windowScene?.interfaceOrientation {
